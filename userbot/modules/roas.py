...
async def _(event):
    ...
    await event.client.send_message(
        event.chat_id,
        "**BUAT LO ANAK ANAK KONTOL YANG GATEL KE JASMINE, LO PADA KONTOL, PALALO LONJONG KOTAK GA SEMPURNA ANJING, MATI AE LO GOBLOK, JASMINE TU CEWE GUE ANJING ASAL LO TAU BANGSAT, SONGONG BANGET LO BERANI GATEL KE JASMINE ANJING, PANGGIL ANTEK ANTEK LO BIAR GUE PUKULIN PALA NYA ATU ATU ANJING, INGET YA KONTOL JASMINE TU CEWE GUE JANGAN LO GATEL KE DIA LAGI NGENTOT!!!**",
    )
    await event.delete()
