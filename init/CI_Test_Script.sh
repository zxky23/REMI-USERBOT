...
tg_sendinfo "<code>I am gonna merge staging into REMI-USERBOT</code>"
cd
...
git push --force origin staging: REMI-USERBOT
tg_sendinfo "<code>I have merged all commits from staging into REMI-USERBOT</code>"
